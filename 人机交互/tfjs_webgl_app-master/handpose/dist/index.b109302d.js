 ...
 */ !function(e, t) {
        ...
        return j(t, z), P(t, [
            {
                ...
                value: function() {
                    ...
                    var n = this.__color.v < 0.5 || this.__color.s > 0.5 ? 255 : 0, o = 255 - n;
    ...
    var se = "Default", ae = function() {
        ...
        this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), X.addClass(this.domElement, "dg"), this.__folders = {
        }, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], o = S.defaults(o, {
            closeOnTop: !1,
            autoPlace: !0,
    ...
    he.toggleHide = function() {
        ...
        getSaveObject: function() {
            ...
            }), e.remembered[this.preset] = x(this)), e.folders = {
        ...
        save: function() {
            ...
            }), this.load.remembered[this.preset] = x(this), _(this, !1), this.saveToLocalStorageIfPossible();
        },
        saveAs: function(e) {
            this.load.remembered || (this.load.remembered = {
            }, this.load.remembered[se] = x(this, !0)), this.load.remembered[e] = x(this), this.preset = e, g(this, e, !0), this.saveToLocalStorageIfPossible();
        },
        revert: function(e) {
...
//# sourceMappingURL=index.b109302d.js.map
